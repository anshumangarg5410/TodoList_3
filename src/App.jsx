      ...
      <div className="main bg-[url(./assets/bg7.webp)] bg-cover bg-no-repeat absolute inset-0 bg-black/40 z-0 bg-center h-screen w-screen flex flex-col justify-start items-center overflow-hidden">
        ...
        <div className={`boxes  mt-4 flex ${completedarea ? "justify-between w-[98%]" : "justify-center w-[100%]"} items-center h-[83%]`}>
          <div className={`box1 rounded-lg shadow-[0_0_3px_#00ffff] h-[95%] ${completedarea ? "w-[49%]" : "w-[98%]"}  backdrop-blur-md bg-[#0d0d0d]/40 transition-all ease-in-out duration-500`}>
           ...
           <div className={`box2 rounded-lg shadow-[0_0_3px_#00ffff] h-[95%] w-[49%] backdrop-blur-md bg-[#0d0d0d]/40  ${completedarea ? "opacity-100 scale-100 pointer-events-auto" : "opacity-0 scale-90 pointer-events-none w-[0%]"} transition-all ease-in-out duration-[500]`}>
